...
<div class="container">
   ...
   $conn = new mysqli($servername, $username, $password, $dbname);
    ...
    $sql = "SELECT id, nom, descripcio, preu, producte FROM product where producte='cachimba'";
                ...
                echo "</div>";
                 echo "<div class='card-footer'>";
                  echo "<button class='btn btn-dark'>";
                   echo "<a href='Detalls.php?id=".$row["id"]."&nom=".$row["nom"]."&descripcio=".$row["descripcio"]."&preu=".$row["preu"]."'>Detalles</a>";
                 echo "</button>";
                 echo "</div>";
             echo "</div>";
        echo "</div>";
